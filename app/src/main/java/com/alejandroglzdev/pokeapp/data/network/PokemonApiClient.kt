...
import com.alejandroglzdev.pokeapp.data.model.PokemonFlavorTextEntries
...
interface PokemonApiClient {
    ...
    suspend fun getPokemonFlavourText(@Path("id") id: Int): Response<PokemonFlavorTextEntries>
}